    ...
    */
    ...
    'configs' => [
        ...
        'default' => [
            ...
            'HTML.Allowed' => 'h1[style],h2[style],h3[style],h4[style],h5[style],h6[style],b[style],strong[style],i[style],em[style],s[style],del[style],u[style],font[color],a[href|title|target],ul,ol,li,p[style],br,span[style],img[width|height|alt|src],blockquote',
