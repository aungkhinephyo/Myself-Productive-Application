...
@section('title', 'Types of Todolist')
@section('content')
    @can('create todolist type')
        <div class="d-flex justify-content-start py-4">
            <a href="{{ route('todolist_type.create') }}" class="btn-theme"><i class="bi bi-plus-circle me-1"></i> Create New
                Type</a>
        </div>
    @endcan
    <div class="card">
    ...
    <script>
        $(document).ready(function() {
            var table = $('.Datatable').DataTable({
                ajax: '/admin/todolist_type/datatable/ssd',
                columns: [{
                        data: 'plus_icon',
                        name: 'plus_icon',
                        'class': 'text-center'
