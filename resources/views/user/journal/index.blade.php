...
@section('content')
    ...
    <div class="d-flex justify-content-start mb-3">
        <a href="{{ route('journal.create') }}" class="btn-theme"><i class="bi bi-plus-circle me-2"></i>New
            Journal</a>
    </div>
        ...
        <div class="card-body py-4 mb-0">
            <table id="Datatable" class="table table-hover Datatable" style="width:100%">
                <thead>
                    ...
                    <th class="text-center" style="width: 150px">Feeling</th>
