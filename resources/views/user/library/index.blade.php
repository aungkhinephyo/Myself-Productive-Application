...
@section('content')
    ...
    <div class="d-flex justify-content-start mb-3">
        <a href="{{ route('library.create') }}" class="btn-theme"><i class="bi bi-plus-circle me-2"></i>
            New Link</a>
    </div>
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function(res) {
                                table.ajax.reload();
                                toastr.info('Library item deleted.')
                            }
                        })
                    }
                })
